    ...
    function (declare) {
        return declare(esri.layers.TiledMapServiceLayer, {
            constructor: function () {//构造函数
                this.spatialReference = new esri.SpatialReference({ wkid: 102100 });//地图的空间参考
                //初始化范围
                ...
                this.resolution = [156543.033928, 78271.5169639999, 39135.7584820001, 19567.8792409999, 9783.93962049996, 4891.96981024998, 2445.98490512499,
                    ...
                    4.77731426794937, 2.38865713397468, 1.19432856685505, 0.597164283559817, 0.298582141647617];//分辨率
                this.tileInfo = new esri.layers.TileInfo({//切片参数
                    "rows": 256,
                    "cols": 256,
